...
Px<-mean(df$metline[union(which(df$stype=='w_Paedomorph'),which(df$stype=='s_Paedomorph'))])
Py<-mean(df$metheight[union(which(df$stype=='w_Paedomorph'),which(df$stype=='s_Paedomorph'))])
